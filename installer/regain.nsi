...
LangString SecLinkName          ${LANG_GERMAN}  "Verkn�pfungen"
LangString SecLinkStartmenuName ${LANG_ENGLISH} "Links in the start menu"
LangString SecLinkStartmenuName ${LANG_GERMAN}  "Verkn�pfungen im Start-Men�"
...
LangString SecLinkAutostartName ${LANG_GERMAN}  "Verkn�pfung im Autostart-Ordner"
